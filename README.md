...
* **Gestión de Prioridades:** Detecta qué tren llega primero a la zona de control (30 cm) y le otorga el paso automáticamente.
* **Sistema de Interbloqueo:** Bloquea la vía contraria mientras una está activa para prevenir colisiones.
* **Alerta de Intrusión:** Si un tren ignora la señal de alto y se acerca a menos de 10 cm, se activa una alarma sonora y un aviso en la pantalla LCD.
